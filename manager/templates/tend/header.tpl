...
<div id="modx-container">
    <div id="modx-header">
         <div id="modx-navbar" style="background: #364044;">
            ...
            <ul id="modx-topnav">
                <li id="modx-home-dashboard">
                    <a href="?" title="{$_config.settings_version}">{$_lang.dashboard}</a> 
                </li>
                <li id="modx-site-info" style="background: url({$_config.manager_url}templates/tend/images/tend_w.png) no-repeat center; background-size: contain; height: 26px; margin-top: 8px;" title="{$_config.settings_version}">
