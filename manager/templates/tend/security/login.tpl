...
<div id="container">
    <div id="modx-login-logo">
        <img alt="ORG. TEND" src="{$_config.manager_url}templates/tend/images/tend.png" onerror="this.src=this.getAttribute('data-fallback');this.onerror=null;" />
    </div>
...
{/if}
    ...
    <p class="loginLicense" style="text-align:center; padding: 5px;">
		V primeru težav se obrnite na <a href="mailto:web@tend.si">web@tend.si</a>
	</p>
</div>
